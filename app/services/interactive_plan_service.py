...
def _execute_plan(
    ...
    planner_problem = build_runtime_planner_problem(robot_config, scene_name)
    robot_to_nav = build_runtime_robot_to_nav_costs(
        robot_config,
        scene_name,
    ...
    return _build_plan_artifacts(raw_result, planner_problem, selection_payload, scene_name, polygon_payload=polygon_payload)
